...
const Search = () => {
  return (
    <div className="w-full py-2 rounded-full cursor-pointer md:w-auto">
      <div className="flex flex-row items-center justify-between ">
        <div className="hidden px-6 text-sm font-semibold sm:block">
        ...
        <Link href="/" className={styles.button}>
          <div className="flex flex-row items-center gap-1 pl-6 pr-2 text-sm font-semibold">
